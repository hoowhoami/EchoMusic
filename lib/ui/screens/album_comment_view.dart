...
class AlbumCommentView extends StatefulWidget {
  const AlbumCommentView({super.key, required this.album});

  final Album album;

  @override
  State<AlbumCommentView> createState() => _AlbumCommentViewState();
}

class _AlbumCommentViewState extends State<AlbumCommentView> {
  ...
  Future<void> _fetchComments({bool isRefresh = false}) async {
    ...
    try {
      final albumId = 'collection_3_${widget.album.singerId}_${widget.album.id}_0';
