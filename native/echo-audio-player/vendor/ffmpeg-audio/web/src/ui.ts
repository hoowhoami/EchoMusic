...
export class AppUI {
  ...
  private timeCurrent = document.getElementById('time-current') as HTMLSpanElement;
  ...
  private selectAlgo = document.getElementById('select-algo') as HTMLSelectElement;

  private sliderVolume = document.getElementById('slider-volume') as HTMLInputElement;
  private valVolume = document.getElementById('val-volume') as HTMLSpanElement;

  private sliderTempo = document.getElementById('slider-tempo') as HTMLInputElement;
  private valTempo = document.getElementById('val-tempo') as HTMLSpanElement;

  private sliderPitch = document.getElementById('slider-pitch') as HTMLInputElement;
  private valPitch = document.getElementById('val-pitch') as HTMLSpanElement;

  private sliderRate = document.getElementById('slider-rate') as HTMLInputElement;
  private valRate = document.getElementById('val-rate') as HTMLSpanElement;

  private btnResetDsp = document.getElementById('btn-reset-dsp') as HTMLButtonElement;
