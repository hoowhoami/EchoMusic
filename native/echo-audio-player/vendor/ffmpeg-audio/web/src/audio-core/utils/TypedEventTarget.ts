...
export class TypedEventTarget<M extends ValueIsEvent<M>> extends EventTarget {
  ...
  /**
   * A helper function for conveniently dispatching CustomEvents. It is intended
   * solely for dispatching CustomEvents; to dispatch other event types such as
   * MouseEvent, please use {@link dispatchTypedEvent}.
   */
