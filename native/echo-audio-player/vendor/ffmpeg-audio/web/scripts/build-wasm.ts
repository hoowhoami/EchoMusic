...
try {
  execSync('cargo build --package ffmpeg_wasm --target wasm32-unknown-emscripten --release', {
    cwd: projectRoot,
    stdio: 'inherit',
  });
} catch {
...
const ffmpegReleaseDir = resolve(projectRoot, 'target/wasm32-unknown-emscripten/release');
