...
// 设置部分标题配置
const sectionTitles: Record<string, { label: string; icon: typeof iconPalette | null }> = {
      ...
      <div ref="contentRef" class="settings-content">
        ...
        <section data-section="appearance" class="settings-section">
          <div class="flex items-center gap-3 mb-4">
            <Icon
              v-if="sectionTitles['appearance'].icon"
              :icon="sectionTitles['appearance'].icon"
              width="20"
              height="20"
              class="text-primary"
            />
        ...
        <!-- 字体设置 -->
        <section data-section="font" class="settings-section">
          <div class="flex items-center gap-3 mb-4">
            <Icon
              v-if="sectionTitles['font'].icon"
              :icon="sectionTitles['font'].icon"
              width="20"
              height="20"
              class="text-primary"
            />
        ...
        <!-- 播放体验 -->
        <section data-section="playback" class="settings-section">
          <div class="flex items-center gap-3 mb-4">
            <Icon
              v-if="sectionTitles['playback'].icon"
              :icon="sectionTitles['playback'].icon"
              width="20"
              height="20"
              class="text-primary"
            />
        ...
        <!-- 播放音质 -->
        <section data-section="quality" class="settings-section">
          <div class="flex items-center gap-3 mb-4">
            <Icon
        ...
        <!-- 桌面歌词 -->
        <section data-section="desktopLyric" class="settings-section">
          <div class="flex items-center gap-3 mb-4">
            <Icon
              ...
              <div v-for="item in shortcutItems" :key="item.command" class="shortcut-grid-row">
                ...
                <div class="shortcut-cell-reset">
                  <button
                    ...
                    title="恢复默认"
                    @click="
                      resetShortcut(item.command, 'local');
                      resetShortcut(item.command, 'global');
                    "
                  >
                    重置
                  </button>
        ...
        <!-- 音频设备 -->
        <section data-section="audioDevice" class="settings-section">
          <div class="flex items-center gap-3 mb-4">
            <Icon
        ...
        <!-- 实验性功能 -->
        <section data-section="experimental" class="settings-section">
          <div class="flex items-center gap-3 mb-4">
            <Icon
        ...
        <!-- 数据与安全 -->
        <section data-section="data" class="settings-section">
          <div class="flex items-center gap-3 mb-4">
            <Icon
        ...
        <!-- 关于 -->
        <section data-section="about" class="settings-section">
          <div class="flex items-center gap-3 mb-4">
            <Icon
