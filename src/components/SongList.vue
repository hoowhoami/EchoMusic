...
import type { Song, Sort } from '@/types';
...
const hasPlaySong = computed(() => {
  return listData.value.findIndex(item => item.hash === musicStore.playSong.id);
});
